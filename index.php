...
<head>
  ...
  <title>Benjamin Venema - Home</title>
...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1>Benjamin Venema</h1>
      <p>I'm <span class="typed" data-typed-items="Programmer, Developer"></span></p>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <section id="resume" class="resume">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up">
            <h3 class="resume-title">Informatie</h3>
            <div class="resume-item pb-0">
              <h4>Benjamin Venema</h4>
              <p><em></em></p>
              <ul>
                <li>Heerenveen, Nederland</li>
                <li>06-49733347</li>
                <li>bvsvenema@gmail.com</li>
              </ul>
            </div>

            <h3 class="resume-title">Opleidingen</h3>
            <div class="resume-item">
              <h4>Applicatie- &amp; Mediaontwikkelaar</h4>
              <h5>2019 - 2023</h5>
              <p><em>Friesland College, Leeuwarden</em></p>
              <p></p>
            </div>
            <div class="resume-item">
              <h4>Vmbo - T / Mavo</h4>
              <h5>2015 - 2019</h5>
              <p><em>OSG Sevenwolden, Heerenveen</em></p>
              <p></p>
            </div>
          </div>
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li data-filter="*" class="filter-active">N-Word</li>
              <li data-filter=".filter-app">Balls</li>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Locatie:</h4>
                <p>Heerenveen, Nederland</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>Bvsvenema@gmail.com</p>
              </div>
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d38457.23828338542!2d5.8860705252285275!3d52.95602683508051!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c85eec0750e1ef%3A0x7237b589801e4b48!2sHeerenveen!5e0!3m2!1snl!2snl!4v1687346183238!5m2!1snl!2snl" frameborder="0" style="border:0; width: 100%; height: 290px;" allowfullscreen></iframe>
            </div>
